        ...
        ElevatedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => Quiz(quizID: Random().nextInt(1000)),
              ),
            );
          },
...
/*class Treinamento {
  ...
  DateTime dataInicialTreinamento;
  DateTime dataFinalTreinamento;
  List<Quiz> quizzes; // Lista de quizzes associados ao treinamento
  ...
  Treinamento({
    ...
    required this.dataInicialTreinamento,
    required this.dataFinalTreinamento,
    this.quizzes = const [], // Valor padrão é uma lista vazia
  });
...
class MenuTreinamentosCrudState extends State<MenuTreinamentos> {
  ...
  void adicionarQuiz(Quiz quiz) {
    setState(() {
      var appState = context.read<MyAppState>();
      var treinamento = appState.treinamentos.last;
      treinamento.quizzes.add(quiz);
    });
  }
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => Quiz(
                  ...
                  onQuizConcluded: adicionarQuiz, // Passa a função de callback para o Quiz
                ),
              ),
            );
          },
