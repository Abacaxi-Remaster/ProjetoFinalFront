...
Para fazer a instalação do programa e conseguir executar o programa corretamente o usuário deve seguir os passos abaixo:
-> Baixar o flutter em <a href = "https://docs.flutter.dev/get-started/install/windows">
