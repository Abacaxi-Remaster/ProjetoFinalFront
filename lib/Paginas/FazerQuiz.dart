...
class FazerQuiz1 extends StatefulWidget {
  final String emailUser;
  final String quizID;

  const FazerQuiz1({required this.emailUser, required this.quizID});

  @override
  FazerQuiz1State createState() => FazerQuiz1State();
}

class FazerQuiz1State extends State<FazerQuiz1> {
  String quizID = '';
  String emailUser = '';
  List<Questao> ListQuestoesBD = []; //recebe os valores do bd
  Map<int, String> listaRespostasMarcada =
...
class FazerQuiz2 extends StatefulWidget {
  final String emailUser;
  final String quizID;

  const FazerQuiz2({required this.emailUser, required this.quizID});

  @override
  FazerQuiz2State createState() => FazerQuiz2State();
}

class FazerQuiz2State extends State<FazerQuiz2> {
  String quizID = '';
  String emailUser = '';
  List<Questao> ListQuestoesBD = []; //recebe os valores do bd
  Map<int, String> listaRespostasMarcada =
